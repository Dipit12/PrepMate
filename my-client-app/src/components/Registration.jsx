    ...
    return (
        <div className="flex justify-center items-center h-screen">
                ...
                <div className="user-input absolute top-20 right-55">
                    ...
                    <div className="input-fields mt-20">
                        <form method="POST" onSubmit={handleFormSubmit}>
                            ...
                            />
                            <img src={userIcon} className=" w-[39px] h-[40px] absolute right-5 bottom-82" alt="user-icon" />
                            ...
                            <input 
                                ...
                                onChange={handleRegistrationChange}
                            />
                            <img src={mailIcon} className=" w-[39px] h-[40px] absolute right-5 bottom-52" alt="mail-icon" />
                            ...
                            <input 
                                ...
                                onChange={handleRegistrationChange}
                            />
                            <img src={lockIcon} className=" w-[39px] h-[40px] absolute right-5 bottom-22" alt="lock-icon" />
                        ...
                        <h2 className="text-white font-poppins mt-7 absolute left-40">
            ...
            <button onClick={() => navigate("/")}>
                <img src={backArrow} className="cursor-pointer w-[55px] h-[auto] absolute top-15 left-35" alt="back-arrow" />
            </button>
        </div>
    );
};
