      ...
      <div className=' w-[1300px] h-[650px] bg-[#1E1E1E] ml-30 my-20 rounded-3xl flex'>
        ...
        <div className='w-[750px] h-[650px] text-white my-10 mx-30 '>
          ...
          <div className='my-15 relative'>
            ...
            <img src = {mailIcon} className = " w-[39px] h-[40px] absolute right-20 bottom-2" alt = "Email Icon"></img> 
          </div>
          <div className='my-15 relative'> 
            ...
            <img src = {lockIcon} className = " w-[39px] h-[40px] absolute right-20 bottom-2" alt = "Lock Icon"></img>
          </div>
          <div className='my-10'>
          ...
          <div className='my-6 mx-33 flex'>
            <p>Forgot your password?</p> <button className='mx-1 text-[#0086FF] font-weight-900'><span className = "ml-1"><Link to = "/verify" className = "text-[rgba(0,134,255,1)] font-[700] text-xl hover:underline">Reset</Link></span></button> 
          </div>
        </div>
      </div>
    </>
